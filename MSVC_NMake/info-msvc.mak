...
help:
	...
	@echo PANGO, CAIROMM, CAIRO, GLIBMM, GLIB, SIGC and HARFBUZZ. Their subdirs, such as
	@echo 'glib-2.0' for GLib, will be searched for, meaning $$(GLIB_INCLUDEDIR)\glib-2.0
	...
	@echo $$(BASE_LIBDIR). DEP includes PANGO, CAIROMM, CAIRO, GLIBMM, GLIB and SIGC. The subdirs,
